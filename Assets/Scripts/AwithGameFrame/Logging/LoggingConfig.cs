...
namespace AwithGameFrame.Logging
{
    ...
    public class LoggingConfig
    {
        ...
        public static LoggingConfig CreatePreset(LoggingSystem.Preset preset)
        {
            var config = new LoggingConfig();
            
            switch (preset)
            {
                case LoggingSystem.Preset.Development:
                ...
                case LoggingSystem.Preset.Production:
                ...
                case LoggingSystem.Preset.Debug:
                    config.Level = LogLevel.Debug;
                ...
                case LoggingSystem.Preset.Performance:
                ...
                case LoggingSystem.Preset.Minimal:
