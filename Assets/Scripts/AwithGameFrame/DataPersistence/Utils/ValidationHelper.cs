...
namespace AwithGameFrame.DataPersistence.Utils
{
    ...
    public static class ValidationHelper
    {
        ...
        public static bool ValidateKey(string key, string context = "DataPersistence")
        {
        ...
        /// <param name="context">上下文信息</param>
        /// <returns>是否有效</returns>
        public static bool ValidateData<T>(T data, string context = "DataPersistence")
        {
            if (data == null)
            {
        ...
        /// <param name="context">上下文信息</param>
        /// <returns>是否有效</returns>
        public static bool ValidateStorageType(StorageType storageType, string context = "DataPersistence")
        {
